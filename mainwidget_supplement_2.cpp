...
void MainWidgetSupplment_2::atmosphericData()
{
...
void MainWidgetSupplment_2::drawAirfoil()
{
...
void MainWidgetSupplment_2::ellipticMethod()
{
...
void MainWidgetSupplment_2::hyperbolicMethod()
{
...
void MainWidgetSupplment_2::Navier_Stokes_equn()
{
...
void MainWidgetSupplment_2::compressibleFlowsNSEquation()
{
//Computing flow: Viscous, compressible flows - Navier-Stokes solver...
//Initial conditions on all points= sea level settings: density, velocity, temperature, viscosity, kinematic viscocity.
//time step= 0
...
void MainWidgetSupplment_2::DomainVertexMethod()
{
    /* Domain Verte method
...
void MainWidgetSupplment_2::unstructuredMethod()
{
    //Unstructured grid...
...
void MainWidgetSupplment_2::BoltzMannEqun()
{
...
void MainWidgetSupplment_2::diagonalFormAsDKS()
{
...
void MainWidgetSupplment_2::relaxationTechniques()
{
...
void MainWidgetSupplment_2::chapmanEnskogTypeCFDSolver()
...
void MainWidgetSupplment_2::compressible_euler_solver()
{
...
void MainWidgetSupplment_2::MonteCarloSimulation()
{
...
void MainWidgetSupplment_2::EulerSolverBoltzmanEquan()
{
...
void MainWidgetSupplment_2::diagonalFormRelaxationSystem()
{
...
void MainWidgetSupplment_2::ChapmanEnskogTypeEulerSolver()
{
...
void MainWidgetSupplment_2::EulerSolverDiscreteKineticSystem()
{
...
void MainWidgetSupplment_2::AdaptiveGrid()
{
...
void MainWidgetSupplment_2::drawFuselage()
{
...
void MainWidgetSupplment_2::drawWing()
{
    float chord = 100;
...
void MainWidgetSupplment_2::drawTail()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
void MainWidgetSupplment_2::drawFin()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
/* Draw a torus */
void MainWidgetSupplment_2::torus(int numc, int numt)
{
   int i, j, k;
...
//! [5]
void MainWidgetSupplment_2::drawCube()
{
    // For cube we would need only 8 vertices but we have to
    // duplicate vertex for each face because texture coordinate
    // is different.
