...
void MainWidgetSupplment_1::atmosphericData()
{
...
void MainWidgetSupplment_1::drawAirfoil()
{
...
void MainWidgetSupplment_1::ellipticMethod()
{
...
void MainWidgetSupplment_1::hyperbolicMethod()
{
...
void MainWidgetSupplment_1::Navier_Stokes_equn()
{
...
void MainWidgetSupplment_1::compressibleFlowsNSEquation()
{
//Computing flow: Viscous, compressible flows - Navier-Stokes solver...
//Initial conditions on all points= sea level settings: density, velocity, temperature, viscosity, kinematic viscocity.
//time step= 0
...
void MainWidgetSupplment_1::DomainVertexMethod()
{
    /* Domain Verte method
...
void MainWidgetSupplment_1::unstructuredMethod()
{
    //Unstructured grid...
...
void MainWidgetSupplment_1::BoltzMannEqun()
{
...
void MainWidgetSupplment_1::diagonalFormAsDKS()
{
...
void MainWidgetSupplment_1::relaxationTechniques()
{
...
void MainWidgetSupplment_1::chapmanEnskogTypeCFDSolver()
...
void MainWidgetSupplment_1::compressible_euler_solver()
{
...
void MainWidgetSupplment_1::MonteCarloSimulation()
{
...
void MainWidgetSupplment_1::EulerSolverBoltzmanEquan()
{
...
void MainWidgetSupplment_1::diagonalFormRelaxationSystem()
{
...
void MainWidgetSupplment_1::ChapmanEnskogTypeEulerSolver()
{
...
void MainWidgetSupplment_1::EulerSolverDiscreteKineticSystem()
{
...
void MainWidgetSupplment_1::AdaptiveGrid()
{
...
void MainWidgetSupplment_1::drawFuselage()
{
...
void MainWidgetSupplment_1::drawWing()
{
    float chord = 100;
...
void MainWidgetSupplment_1::drawTail()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
void MainWidgetSupplment_1::drawFin()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
/* Draw a torus */
void MainWidgetSupplment_1::torus(int numc, int numt)
{
   int i, j, k;
...
//! [5]
void MainWidgetSupplment_1::drawCube()
{
    // For cube we would need only 8 vertices but we have to
    // duplicate vertex for each face because texture coordinate
    // is different.
