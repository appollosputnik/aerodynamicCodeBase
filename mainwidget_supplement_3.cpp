...
void MainWidgetSupplment_3::atmosphericData()
{
...
void MainWidgetSupplment_3::drawAirfoil()
{
...
void MainWidgetSupplment_3::ellipticMethod()
{
...
void MainWidgetSupplment_3::hyperbolicMethod()
{
...
void MainWidgetSupplment_3::Navier_Stokes_equn()
{
...
void MainWidgetSupplment_3::compressibleFlowsNSEquation()
{
//Computing flow: Viscous, compressible flows - Navier-Stokes solver...
//Initial conditions on all points= sea level settings: density, velocity, temperature, viscosity, kinematic viscocity.
//time step= 0
...
void MainWidgetSupplment_3::DomainVertexMethod()
{
    /* Domain Verte method
...
void MainWidgetSupplment_3::unstructuredMethod()
{
    //Unstructured grid...
...
void MainWidgetSupplment_3::BoltzMannEqun()
{
...
void MainWidgetSupplment_3::diagonalFormAsDKS()
{
...
void MainWidgetSupplment_3::relaxationTechniques()
{
...
void MainWidgetSupplment_3::chapmanEnskogTypeCFDSolver()
...
void MainWidgetSupplment_3::compressible_euler_solver()
{
...
void MainWidgetSupplment_3::MonteCarloSimulation()
{
...
void MainWidgetSupplment_3::EulerSolverBoltzmanEquan()
{
...
void MainWidgetSupplment_3::diagonalFormRelaxationSystem()
{
...
void MainWidgetSupplment_3::ChapmanEnskogTypeEulerSolver()
{
...
void MainWidgetSupplment_3::EulerSolverDiscreteKineticSystem()
{
...
void MainWidgetSupplment_3::AdaptiveGrid()
{
...
void MainWidgetSupplment_3::drawFuselage()
{
...
void MainWidgetSupplment_3::drawWing()
{
    float chord = 100;
...
void MainWidgetSupplment_3::drawTail()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
void MainWidgetSupplment_3::drawFin()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
