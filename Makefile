...
# Template: app
# Command: C:/Qt/Qt5.14.2/5.14.2/mingw73_32/bin/qmake.exe -o Makefile best_practices_gl_qt.pro -spec win32-g++ CONFIG+=qtquickcompiler
#############################################################################
...
Makefile: best_practices_gl_qt.pro C:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/features/spec_pre.prf \
		...
		shaders.qrc \
		textures.qrc
	$(QMAKE) -o Makefile best_practices_gl_qt.pro -spec win32-g++ CONFIG+=qtquickcompiler
